...
2.  **Meetings Page:**
    - This page lists your most recent meetings (up to 10).
    - For each meeting, you can see the platform (Google Meet, Teams, Zoom), timestamp, and duration.

## Downloading Transcripts
- On the **Meetings Page**, click the **Download** icon (downward arrow) next to a meeting.
- The transcript will be downloaded as a `.txt` file containing both the transcript text and any captured chat messages.
...
- **Manual mode:** Requires you to manually toggle the extension via the CC icon in Google Meet.
- You can switch modes in the extension popup.
